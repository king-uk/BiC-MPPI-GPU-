...
int main() {
  ...
  // SVGD-MPPI는 각 particle이 istep번 surrogate gradient step을 수행하므로
  // Nf/Nb는 총 rollout 수 대신 particle 수 (적게 설정)
  ...
  // param.Nf = 300;
  // param.Nb = 300;
  // param.Ns = 30;   // surrogate samples per SVGD step
