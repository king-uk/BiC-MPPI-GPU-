...
int main() {
  std::cout << "Starting Manipulator Log MPPI (Velocity Control)..." << std::endl;
  ...
  std::ofstream csv_file("x_init_log_mppi_log.csv");
  if (!csv_file.is_open()) {
