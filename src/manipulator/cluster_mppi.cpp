...
int main() {
  std::cout << "Starting Manipulator Cluster MPPI (Velocity Control)..."
            << std::endl;
  ...
  std::ofstream csv_file("x_init_cluster_log.csv");
  if (!csv_file.is_open()) {
