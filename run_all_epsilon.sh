#!/bin/bash
# ============================================================
# run_all_epsilon.sh  –  wmrobot epsilon benchmark 전체 실행 스크립트
# 프로젝트 루트에서 실행 가능: bash run_all_epsilon.sh
#
...
SOLVERS=( bi_mppi_epsilon_0.001 bi_mppi_epsilon_0.005 bi_mppi_epsilon_0.1 bi_mppi_epsilon_0.5 bi_mppi_epsilon_1 bi_mppi)

# 순차 실행 여부 (1=순차, 0=병렬)
SEQUENTIAL=${SEQUENTIAL:-1}

echo "======================================"
echo "  WMRobot Epsilon Benchmark Runner"
